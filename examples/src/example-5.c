...
int main(void) {
    ...
    TextBoxEffect * effect = text_box_effect_typewriter_make(35);
    ...
    while (!WindowShouldClose()) {
        ...
        } else if (!text_box_effect_typewriter_has_finished(effect)) {
            text_box_effect_typewriter_cancel(effect);
    ...
    text_box_effect_typewriter_destroy(effect);
